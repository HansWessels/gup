...
/*****************************************************************************
 *																			 *
 * Member functions of the arj_mainheader class.							 *
 *																			 *
 *****************************************************************************/

arj_mainheader::arj_mainheader(const char *comment) : mainheader(comment)
{
	hdr_type = MHDR_ARJ;
...
arj_mainheader::arj_mainheader(const arj_mainheader& from) : mainheader(from)
{
...
arj_mainheader::~arj_mainheader(void)
{
	if (filename != NULL)
		delete[] filename;
}
...
/*
 * void arj_mainheader::set_filename(const char *filename)
 *
...
/*
 * void arj_mainheader::set_filename(const char *new_filename, uint16 fspecpos)
 *
 * Change the filename.
 */
...
/*****************************************************************************
 *																			 *
 * Member functions of the arj_fileheader class.							 *
 *																			 *
 *****************************************************************************/

/*
 * void arj_fileheader::update_file_attributes(void)
 *
...
/*
 * void arj_fileheader::init(const char *filename)
 *
 * Initialise all variables in the arj_fileheader class.
 *
 * Parameters:
 *
...
arj_fileheader::arj_fileheader(const char *filename, const char *comment) : fileheader(NULL, comment)
{
	init(filename);
}

arj_fileheader::arj_fileheader(const char *filename, const char *comment,
							   const osstat *stat) : fileheader(NULL, comment, stat)
{
	init(filename);
}

arj_fileheader::~arj_fileheader(void)
{
}

/*
 * void arj_fileheader::set_filename(const char *filename)
 *
 * Change the filename. The position of the fspec is determined
 * automatically by this version.
 */
...
/*
 * void arj_fileheader::set_filename(const char *new_filename, uint16 fspecpos)
 *
 * Change the filename.
 */
...
/*
 * int arj_fileheader::get_header_len(void)
 *
 * Get the length the header would have on disk.
 */

int arj_fileheader::get_header_len(void) const
{
	int len;
	uint16 fspec_pos;
	char *arj_name;
...
/*
 * int arj_fileheader::has_crc(void)
 *
...
int arj_fileheader::has_crc(void) const
{
	return 1;
}

/*
 * void arj_fileheader::update_ext_hdrs(void)
 *
...
/*
 * void arj_fileheader::set_file_stat(const osstat *stat)
 *
...
/*
 * void arj_fileheader::mv_set_segment_cnt(int count)
 *
...
int arj_fileheader::mv_is_continuation(void)
{
