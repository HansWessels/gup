...
/**************************************************************************
 * File:     osrtl/windows/error/error.h                                  *
...
// @(#) osrtl/windows/error/error.h  -  Error handling
...
#include "osrtl/windows/settings.h"     // settings for the unit <osrtl>

// Modules of the component <error>.
#include "osrtl/windows/error/rescode/rescode.h"   // result codes
#include "osrtl/windows/error/errmsg/errmsg.h"     // error messages
...
/**************************************************************************
 * End of osrtl/windows/error/error.h .                                   *
 **************************************************************************/
