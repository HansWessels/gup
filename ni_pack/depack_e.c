...
void decode(int mode, unsigned long size, uint32_t crc, uint8_t *data, unsigned long compressed_size)
   ...
   /*      DATA10.BIN                   7082          2644  10  5944648C */
	...
	for(;;)
	{
		...
		{ /* ARJ header gevonden */
			...
			decode(method, original_size, crc32, data+offset, compressed_size);
			printf("\n");
